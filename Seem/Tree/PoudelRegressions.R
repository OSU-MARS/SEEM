...
ggplot() +
  ...
  geom_path(aes(x = 0.83 * seq(5, 120), y = pmax(-0.7 + 1/(0.02*30) + 0.01 * (0.8 + 0.045*30) * seq(5, 120), 0.15)), color = "grey70", linetype = "longdash") +
  ...
  coord_cartesian(xlim = c(0, 120), ylim = c(0, 25)) +
  labs(x = NULL, y = "height, m", color = "DBH, cm") +
  theme(legend.position = "none") +
ggplot() +
  geom_hline(yintercept = c(0.15, 1.3, 7.62 + 0.15, 12.4986 + 0.15), color = "grey70", linetype = "longdash") +
  geom_path(aes(x = 0.82 * seq(5, 119), y = pmax(-0.7 + 1/(0.02*50) + 0.01 * (0.8 + 0.045*50) * seq(5, 119), 0.15)), color = "grey70", linetype = "longdash") +
...
ggplot() +
  geom_hline(yintercept = c(0.15, 1.3, 7.62 + 0.15, 12.4986 + 0.15), color = "grey70", linetype = "longdash") +
  geom_path(aes(x = 0.9 * seq(5, 54), y = pmax(-0.7 + 1/(0.02*80) + 0.01 * (0.8 + 0.045*80) * seq(5, 54), 0.15)), color = "grey70", linetype = "longdash") +
...
ggplot() +
  geom_hline(yintercept = c(0.15, 1.3, 7.62 + 0.15, 12.4986 + 0.15), color = "grey70", linetype = "longdash") +
  geom_path(aes(x = 1.0 * seq(5, 23), y = pmax(-0.7 + 1/(0.02*150) + 0.01 * (0.8 + 0.045*150) * seq(5, 23), 0.15)), color = "grey70", linetype = "longdash") +
...
ggplot() +
  geom_hline(yintercept = c(0.15, 1.3, 7.62 + 0.15, 12.4986 + 0.15), color = "grey70", linetype = "longdash") +
  geom_path(aes(x = 0.81 * seq(5, 120), y = pmax(0.4 - 1/(0.035*30) + 0.01 * (3.25 + 0.025*30) * seq(5, 120), 0.15)), color = "grey70", linetype = "longdash") +
...
ggplot() +
  geom_hline(yintercept = c(0.15, 1.3, 7.62 + 0.15, 12.4986 + 0.15), color = "grey70", linetype = "longdash") +
  geom_path(aes(x = 0.80 * seq(5, 119), y = pmax(0.4 - 1/(0.035*50) + 0.01 * (3.25 + 0.025*50) * seq(5, 119), 0.15)), color = "grey70", linetype = "longdash") +
...
ggplot() +
  geom_hline(yintercept = c(0.15, 1.3, 7.62 + 0.15, 12.4986 + 0.15), color = "grey70", linetype = "longdash") +
  geom_path(aes(x = 0.92 * seq(5, 54), y = pmax(0.4 - 1/(0.035*80) + 0.01 * (3.25 + 0.025*80) * seq(5, 54), 0.15)), color = "grey70", linetype = "longdash") +
...
ggplot() +
  geom_hline(yintercept = c(0.15, 1.3, 7.62 + 0.15, 12.4986 + 0.15), color = "grey70", linetype = "longdash") +
  geom_path(aes(x = 1.0 * seq(5, 23), y = pmax(0.4 - 1/(0.035*150) + 0.01 * (3.25 + 0.025*150) * seq(5, 23), 0.15)), color = "grey70", linetype = "longdash") +

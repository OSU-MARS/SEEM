...
namespace Mars.Seem.Extensions
{
    public class MathAvx10
    {
        ...
        {
            return MathAvx10.Exp2(Avx512.Multiply(Vector256.Create(Constant.Math.ExpToExp2), power));
        }
        ...
        {
            Debug.Assert(Avx512.MoveMask(Avx512.And(Avx512.CompareGreaterThan(power, Vector256.Create(Constant.Math.FloatExp2MaximumPower)), Avx512.CompareOrdered(power, power))) == 0);

            Vector256<float> integerPowerAsFloat = Avx512.VL.RoundScale(power, Constant.Avx512.RoundToZero);
            Vector256<float> fractionalPower = Avx512.Subtract(power, integerPowerAsFloat);
            Vector256<float> fractionSquared = Avx512.Multiply(fractionalPower, fractionalPower);

            Vector256<float> c1 = Vector256.Create(Constant.Math.ExpC1);
            Vector256<float> a = Avx512.Add(fractionalPower, Avx512.Multiply(c1, Avx512.Multiply(fractionSquared, fractionalPower)));
            Vector256<float> c2 = Vector256.Create(Constant.Math.ExpC2);
            Vector256<float> c3 = Vector256.Create(Constant.Math.ExpC3);
            Vector256<float> b = Avx512.Add(c3, Avx512.Multiply(c2, fractionSquared));
            Vector256<float> fractionalInterpolant = Avx512.Divide(Avx512.Add(b, a), Avx512.Subtract(b, a));

            Vector256<int> integerPower = Avx512.ConvertToVector256Int32(integerPowerAsFloat); // res = 2^intPart
            Vector256<int> integerExponent = Avx512.ShiftLeftLogical(integerPower, 23);
            Vector256<float> exponent = Avx512.Add(integerExponent, fractionalInterpolant.AsInt32()).AsSingle();

            Vector256<float> zeroMask = Avx512.CompareLessThan(power, Vector256.Create(-Constant.Math.FloatExp2MaximumPower));
        ...
        {
            return MathAvx10.Exp2(Avx512.Multiply(Vector256.Create(Constant.Math.Exp10ToExp2), power));
        }
        ...
        {
            return Avx512.Multiply(Vector256.Create(Constant.Math.Log2ToNaturalLog), MathAvx10.Log2(value));
        }
        ...
        public static Vector256<float> Log2(Vector256<float> value)
        {
            ...
            Vector256<float> x = Avx512.Subtract(mantissa, Vector256.Create(Constant.Math.One));
            Vector256<float> polynomial = Avx512.Multiply(beta1, x);
            Vector256<float> x2 = Avx512.Multiply(x, x);
            polynomial = Avx512.Add(polynomial, Avx512.Multiply(beta2, x2));
            Vector256<float> x3 = Avx512.Multiply(x2, x);
            polynomial = Avx512.Add(polynomial, Avx512.Multiply(beta3, x3));
            Vector256<float> x4 = Avx512.Multiply(x3, x);
            polynomial = Avx512.Add(polynomial, Avx512.Multiply(beta4, x4));
            Vector256<float> x5 = Avx512.Multiply(x4, x);
        ...
        {
            return Avx512.Multiply(Vector256.Create(Constant.Math.Log2ToLog10), MathAvx10.Log2(value));
        }
        ...
        public static Vector256<float> MaskExp(Vector256<float> power, Vector256<float> exponentMask)
        {
            ...
            Vector256<float> restrictedPower = Avx512.BlendVariable(power, Vector256.Create(1.0F), exponentMask);
            Vector256<float> exponent = Avx512.BlendVariable(MathAvx10.Exp(restrictedPower), Vector256<float>.Zero, exponentMask);
            return exponent;
        }

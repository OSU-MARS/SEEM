...
namespace Mars.Seem.Output
{
    public class StandTrajectoryArrowMemory : ArrowMemory
    {
        ...
        private void Add(StandTrajectory trajectory, int startPeriod, WriteStandTrajectoryContext writeContext, int startIndexInRecordBatch, int periodsToCopy)
        {
            ...
            Span<Int16> batchThin1 = MemoryMarshal.Cast<byte, Int16>(this.thin1.AsSpan());
            Span<Int16> batchThin2 = MemoryMarshal.Cast<byte, Int16>(this.thin2.AsSpan());
            Span<Int16> batchThin3 = MemoryMarshal.Cast<byte, Int16>(this.thin3.AsSpan());
            Span<Int16> batchRotation = MemoryMarshal.Cast<byte, Int16>(this.rotation.AsSpan());
            Span<UInt32> batchFinancialScenario = MemoryMarshal.Cast<byte, UInt32>(this.financialScenario.AsSpan());
            ...
            // tree growth
            Span<float> batchTph = MemoryMarshal.Cast<byte, float>(this.tph.AsSpan());
            Span<float> batchQmd = MemoryMarshal.Cast<byte, float>(this.qmd.AsSpan());
            Span<float> batchHtop = MemoryMarshal.Cast<byte, float>(this.hTop.AsSpan());
            Span<float> batchBasalArea = MemoryMarshal.Cast<byte, float>(this.basalArea.AsSpan());
            Span<float> batchSdi = MemoryMarshal.Cast<byte, float>(this.reinekeSdi.AsSpan());
            Span<float> batchStandingCmh = MemoryMarshal.Cast<byte, float>(this.standingCmh.AsSpan());
            Span<float> batchStandingMbfh = MemoryMarshal.Cast<byte, float>(this.standingMbfh.AsSpan());
            Span<float> batchThinCmh = MemoryMarshal.Cast<byte, float>(this.thinCmh.AsSpan());
            Span<float> batchThinMbfh = MemoryMarshal.Cast<byte, float>(this.thinMbfh.AsSpan());
            Span<float> batchBAremoved = MemoryMarshal.Cast<byte, float>(this.baRemoved.AsSpan());
            Span<float> batchBAintensity = MemoryMarshal.Cast<byte, float>(this.baIntensity.AsSpan());
            Span<float> batchTPHdecrease = MemoryMarshal.Cast<byte, float>(this.tphDecrease.AsSpan());
            // financial
            Span<float> batchNpv = MemoryMarshal.Cast<byte, float>(this.npv.AsSpan());
            Span<float> batchLev = MemoryMarshal.Cast<byte, float>(this.lev.AsSpan());
            // carbon - not supported for now
            // Span<float> batchLiveTreeBiomass = MemoryMarshal.Cast<byte, float>(this.LiveTreeBiomass.AsSpan());
            // Span<float> batchSph = MemoryMarshal.Cast<byte, float>(this.Sph.AsSpan());
            // Span<float> batchQ = MemoryMarshal.Cast<byte, float>(this.Q.AsSpan());
            // harvest cost
            Span<HarvestSystemEquipment> batchThinMinCostSystem = MemoryMarshal.Cast<byte, HarvestSystemEquipment>(this.thinMinCostSystem.AsSpan());
            Span<float> batchThinFallerGrappleSwingYarderCost = MemoryMarshal.Cast<byte, float>(this.thinFallerGrappleSwingYarderCost.AsSpan());
            Span<float> batchThinFallerGrappleYoaderCost = MemoryMarshal.Cast<byte, float>(this.thinFallerGrappleYoaderCost.AsSpan());
            Span<float> batchThinFellerBuncherGrappleSwingYarderCost = MemoryMarshal.Cast<byte, float>(this.thinFellerBuncherGrappleSwingYarderCost.AsSpan());
            Span<float> batchThinFellerBuncherGrappleYoaderCost = MemoryMarshal.Cast<byte, float>(this.thinFellerBuncherGrappleYoaderCost.AsSpan());
            Span<float> batchThinTrackedHarvesterForwarderCost = MemoryMarshal.Cast<byte, float>(this.thinTrackedHarvesterForwarderCost.AsSpan());
            Span<float> batchThinTrackedHarvesterGrappleSwingYarderCost = MemoryMarshal.Cast<byte, float>(this.thinTrackedHarvesterGrappleSwingYarderCost.AsSpan());
            Span<float> batchThinTrackedHarvesterGrappleYoaderCost = MemoryMarshal.Cast<byte, float>(this.thinTrackedHarvesterGrappleYoaderCost.AsSpan());
            Span<float> batchThinWheeledHarvesterForwarderCost = MemoryMarshal.Cast<byte, float>(this.thinWheeledHarvesterForwarderCost.AsSpan());
            Span<float> batchThinWheeledHarvesterGrappleSwingYarderCost = MemoryMarshal.Cast<byte, float>(this.thinWheeledHarvesterGrappleSwingYarderCost.AsSpan());
            Span<float> batchThinWheeledHarvesterGrappleYoaderCost = MemoryMarshal.Cast<byte, float>(this.thinWheeledHarvesterGrappleYoaderCost.AsSpan());
            Span<float> batchThinTaskCost = MemoryMarshal.Cast<byte, float>(this.thinTaskCost.AsSpan());
            Span<HarvestSystemEquipment> batchRegenMinCostSystem = MemoryMarshal.Cast<byte, HarvestSystemEquipment>(this.regenMinCostSystem.AsSpan());
            Span<float> batchRegenFallerGrappleSwingYarderCost = MemoryMarshal.Cast<byte, float>(this.regenFallerGrappleSwingYarderCost.AsSpan());
            Span<float> batchRegenFallerGrappleYoaderCost = MemoryMarshal.Cast<byte, float>(this.regenFallerGrappleYoaderCost.AsSpan());
            Span<float> batchRegenFellerBuncherGrappleSwingYarderCost = MemoryMarshal.Cast<byte, float>(this.regenFellerBuncherGrappleSwingYarderCost.AsSpan());
            Span<float> batchRegenFellerBuncherGrappleYoaderCost = MemoryMarshal.Cast<byte, float>(this.regenFellerBuncherGrappleYoaderCost.AsSpan());
            Span<float> batchRegenTrackedHarvesterGrappleSwingYarderCost = MemoryMarshal.Cast<byte, float>(this.regenTrackedHarvesterGrappleSwingYarderCost.AsSpan());
            Span<float> batchRegenTrackedHarvesterGrappleYoaderCost = MemoryMarshal.Cast<byte, float>(this.regenTrackedHarvesterGrappleYoaderCost.AsSpan());
            Span<float> batchRegenWheeledHarvesterGrappleSwingYarderCost = MemoryMarshal.Cast<byte, float>(this.regenWheeledHarvesterGrappleSwingYarderCost.AsSpan());
            Span<float> batchRegenWheeledHarvesterGrappleYoaderCost = MemoryMarshal.Cast<byte, float>(this.regenWheeledHarvesterGrappleYoaderCost.AsSpan());
            Span<float> batchRegenTaskCost = MemoryMarshal.Cast<byte, float>(this.regenTaskCost.AsSpan());
            Span<float> batchReforestationNpv = MemoryMarshal.Cast<byte, float>(this.reforestationNpv.AsSpan());
            // timber sorts
            Span<float> batchThinLogs2S = MemoryMarshal.Cast<byte, float>(this.thinLogs2S.AsSpan());
            Span<float> batchThinLogs3S = MemoryMarshal.Cast<byte, float>(this.thinLogs3S.AsSpan());
            Span<float> batchThinLogs4S = MemoryMarshal.Cast<byte, float>(this.thinLogs4S.AsSpan());
            Span<float> batchThinCmh2S = MemoryMarshal.Cast<byte, float>(this.thinCmh2S.AsSpan());
            Span<float> batchThinCmh3S = MemoryMarshal.Cast<byte, float>(this.thinCmh3S.AsSpan());
            Span<float> batchThinCmh4S = MemoryMarshal.Cast<byte, float>(this.thinCmh4S.AsSpan());
            Span<float> batchThinMbfh2S = MemoryMarshal.Cast<byte, float>(this.thinMbfh2S.AsSpan());
            Span<float> batchThinMbfh3S = MemoryMarshal.Cast<byte, float>(this.thinMbfh3S.AsSpan());
            Span<float> batchThinMbfh4S = MemoryMarshal.Cast<byte, float>(this.thinMbfh4S.AsSpan());
            Span<float> batchThinPond2S = MemoryMarshal.Cast<byte, float>(this.thinPond2S.AsSpan());
            Span<float> batchThinPond3S = MemoryMarshal.Cast<byte, float>(this.thinPond3S.AsSpan());
            Span<float> batchThinPond4S = MemoryMarshal.Cast<byte, float>(this.thinPond4S.AsSpan());
            Span<float> batchStandingLogs2S = MemoryMarshal.Cast<byte, float>(this.standingLogs2S.AsSpan());
            Span<float> batchStandingLogs3S = MemoryMarshal.Cast<byte, float>(this.standingLogs3S.AsSpan());
            Span<float> batchStandingLogs4S = MemoryMarshal.Cast<byte, float>(this.standingLogs4S.AsSpan());
            Span<float> batchStandingCmh2S = MemoryMarshal.Cast<byte, float>(this.standingCmh2S.AsSpan());
            Span<float> batchStandingCmh3S = MemoryMarshal.Cast<byte, float>(this.standingCmh3S.AsSpan());
            Span<float> batchStandingCmh4S = MemoryMarshal.Cast<byte, float>(this.standingCmh4S.AsSpan());
            Span<float> batchStandingMbfh2S = MemoryMarshal.Cast<byte, float>(this.standingMbfh2S.AsSpan());
            Span<float> batchStandingMbfh3S = MemoryMarshal.Cast<byte, float>(this.standingMbfh3S.AsSpan());
            Span<float> batchStandingMbfh4S = MemoryMarshal.Cast<byte, float>(this.standingMbfh4S.AsSpan());
            Span<float> batchRegenPond2S = MemoryMarshal.Cast<byte, float>(this.regenPond2S.AsSpan());
            Span<float> batchRegenPond3S = MemoryMarshal.Cast<byte, float>(this.regenPond3S.AsSpan());
            Span<float> batchRegenPond4S = MemoryMarshal.Cast<byte, float>(this.regenPond4S.AsSpan());
            // equipment productivity
            Span<float> batchThinFallerPMh = MemoryMarshal.Cast<byte, float>(this.thinFallerPMh.AsSpan());
            Span<float> batchThinFallerProductivity = MemoryMarshal.Cast<byte, float>(this.thinFallerProductivity.AsSpan());
            Span<float> batchThinFellerBuncherPMh = MemoryMarshal.Cast<byte, float>(this.thinFellerBuncherPMh.AsSpan());
            Span<float> batchThinFellerBuncherProductivity = MemoryMarshal.Cast<byte, float>(this.thinFellerBuncherProductivity.AsSpan());
            Span<float> batchThinTrackedHarvesterPMh = MemoryMarshal.Cast<byte, float>(this.thinTrackedHarvesterPMh.AsSpan());
            Span<float> batchThinTrackedHarvesterProductivity = MemoryMarshal.Cast<byte, float>(this.thinTrackedHarvesterProductivity.AsSpan());
            Span<float> batchThinWheeledHarvesterPMh = MemoryMarshal.Cast<byte, float>(this.thinWheeledHarvesterPMh.AsSpan());
            Span<float> batchThinWheeledHarvesterProductivity = MemoryMarshal.Cast<byte, float>(this.thinWheeledHarvesterProductivity.AsSpan());
            Span<ChainsawCrewType> batchThinChainsawCrewWithFellerBuncherAndGrappleSwingYarder = MemoryMarshal.Cast<byte, ChainsawCrewType>(this.thinChainsawCrewWithFellerBuncherAndGrappleSwingYarder.AsSpan());
            Span<float> batchThinChainsawUtilizationWithFellerBuncherAndGrappleSwingYarder = MemoryMarshal.Cast<byte, float>(this.thinChainsawUtilizationWithFellerBuncherAndGrappleSwingYarder.AsSpan());
            Span<float> batchThinChainsawCmhWithFellerBuncherAndGrappleSwingYarder = MemoryMarshal.Cast<byte, float>(this.thinChainsawCmhWithFellerBuncherAndGrappleSwingYarder.AsSpan());
            Span<float> batchThinChainsawPMhWithFellerBuncherAndGrappleSwingYarder = MemoryMarshal.Cast<byte, float>(this.thinChainsawPMhWithFellerBuncherAndGrappleSwingYarder.AsSpan());
            Span<ChainsawCrewType> batchThinChainsawCrewWithFellerBuncherAndGrappleYoader = MemoryMarshal.Cast<byte, ChainsawCrewType>(this.thinChainsawCrewWithFellerBuncherAndGrappleYoader.AsSpan());
            Span<float> batchThinChainsawUtilizationWithFellerBuncherAndGrappleYoader = MemoryMarshal.Cast<byte, float>(this.thinChainsawUtilizationWithFellerBuncherAndGrappleYoader.AsSpan());
            Span<float> batchThinChainsawCmhWithFellerBuncherAndGrappleYoader = MemoryMarshal.Cast<byte, float>(this.thinChainsawCmhWithFellerBuncherAndGrappleYoader.AsSpan());
            Span<float> batchThinChainsawPMhWithFellerBuncherAndGrappleYoader = MemoryMarshal.Cast<byte, float>(this.thinChainsawPMhWithFellerBuncherAndGrappleYoader.AsSpan());
            Span<ChainsawCrewType> batchThinChainsawCrewWithTrackedHarvester = MemoryMarshal.Cast<byte, ChainsawCrewType>(this.thinChainsawCrewWithTrackedHarvester.AsSpan());
            Span<float> batchThinChainsawUtilizationWithTrackedHarvester = MemoryMarshal.Cast<byte, float>(this.thinChainsawUtilizationWithTrackedHarvester.AsSpan());
            Span<float> batchThinChainsawCmhWithTrackedHarvester = MemoryMarshal.Cast<byte, float>(this.thinChainsawCmhWithTrackedHarvester.AsSpan());
            Span<float> batchThinChainsawPMhWithTrackedHarvester = MemoryMarshal.Cast<byte, float>(this.thinChainsawPMhWithTrackedHarvester.AsSpan());
            Span<ChainsawCrewType> batchThinChainsawCrewWithWheeledHarvester = MemoryMarshal.Cast<byte, ChainsawCrewType>(this.thinChainsawCrewWithWheeledHarvester.AsSpan());
            Span<float> batchThinChainsawUtilizationWithWheeledHarvester = MemoryMarshal.Cast<byte, float>(this.thinChainsawUtilizationWithWheeledHarvester.AsSpan());
            Span<float> batchThinChainsawCmhWithWheeledHarvester = MemoryMarshal.Cast<byte, float>(this.thinChainsawCmhWithWheeledHarvester.AsSpan());
            Span<float> batchThinChainsawPMhWithWheeledHarvester = MemoryMarshal.Cast<byte, float>(this.thinChainsawPMhWithWheeledHarvester.AsSpan());
            Span<ForwarderLoadingMethod> batchThinForwardingMethod = MemoryMarshal.Cast<byte, ForwarderLoadingMethod>(this.thinForwardingMethod.AsSpan());
            Span<float> batchThinForwarderPMh = MemoryMarshal.Cast<byte, float>(this.thinForwarderPMh.AsSpan());
            Span<float> batchThinForwarderProductivity = MemoryMarshal.Cast<byte, float>(this.thinForwarderProductivity.AsSpan());
            Span<float> batchThinForwardedWeight = MemoryMarshal.Cast<byte, float>(this.thinForwardedWeight.AsSpan());
            Span<float> batchThinGrappleSwingYarderPMhPerHectare = MemoryMarshal.Cast<byte, float>(this.thinGrappleSwingYarderPMhPerHectare.AsSpan());
            Span<float> batchThinGrappleSwingYarderProductivity = MemoryMarshal.Cast<byte, float>(this.thinGrappleSwingYarderProductivity.AsSpan());
            Span<float> batchThinGrappleSwingYarderOverweightFirstLogsPerHectare = MemoryMarshal.Cast<byte, float>(this.thinGrappleSwingYarderOverweightFirstLogsPerHectare.AsSpan());
            Span<float> batchThinGrappleYoaderPMhPerHectare = MemoryMarshal.Cast<byte, float>(this.thinGrappleYoaderPMhPerHectare.AsSpan());
            Span<float> batchThinGrappleYoaderProductivity = MemoryMarshal.Cast<byte, float>(this.thinGrappleYoaderProductivity.AsSpan());
            Span<float> batchThinGrappleYoaderOverweightFirstLogsPerHectare = MemoryMarshal.Cast<byte, float>(this.thinGrappleYoaderOverweightFirstLogsPerHectare.AsSpan());
            Span<float> batchThinProcessorPMhWithGrappleSwingYarder = MemoryMarshal.Cast<byte, float>(this.thinProcessorPMhWithGrappleSwingYarder.AsSpan());
            Span<float> batchThinProcessorProductivityWithGrappleSwingYarder = MemoryMarshal.Cast<byte, float>(this.thinProcessorProductivityWithGrappleSwingYarder.AsSpan());
            Span<float> batchThinProcessorPMhWithGrappleYoader = MemoryMarshal.Cast<byte, float>(this.thinProcessorPMhWithGrappleYoader.AsSpan());
            Span<float> batchThinProcessorProductivityWithGrappleYoader = MemoryMarshal.Cast<byte, float>(this.thinProcessorProductivityWithGrappleYoader.AsSpan());
            Span<float> batchThinLoadedWeight = MemoryMarshal.Cast<byte, float>(this.thinLoadedWeight.AsSpan());
            
            Span<float> batchRegenFallerPMh = MemoryMarshal.Cast<byte, float>(this.regenFallerPMh.AsSpan());
            Span<float> batchRegenFallerProductivity = MemoryMarshal.Cast<byte, float>(this.regenFallerProductivity.AsSpan());
            Span<float> batchRegenFellerBuncherPMh = MemoryMarshal.Cast<byte, float>(this.regenFellerBuncherPMh.AsSpan());
            Span<float> batchRegenFellerBuncherProductivity = MemoryMarshal.Cast<byte, float>(this.regenFellerBuncherProductivity.AsSpan());
            Span<float> batchRegenTrackedHarvesterPMh = MemoryMarshal.Cast<byte, float>(this.regenTrackedHarvesterPMh.AsSpan());
            Span<float> batchRegenTrackedHarvesterProductivity = MemoryMarshal.Cast<byte, float>(this.regenTrackedHarvesterProductivity.AsSpan());
            Span<float> batchRegenWheeledHarvesterPMh = MemoryMarshal.Cast<byte, float>(this.regenWheeledHarvesterPMh.AsSpan());
            Span<float> batchRegenWheeledHarvesterProductivity = MemoryMarshal.Cast<byte, float>(this.regenWheeledHarvesterProductivity.AsSpan());
            Span<ChainsawCrewType> batchRegenChainsawCrewWithFellerBuncherAndGrappleSwingYarder = MemoryMarshal.Cast<byte, ChainsawCrewType>(this.regenChainsawCrewWithFellerBuncherAndGrappleSwingYarder.AsSpan());
            Span<float> batchRegenChainsawUtilizationWithFellerBuncherAndGrappleSwingYarder = MemoryMarshal.Cast<byte, float>(this.regenChainsawUtilizationWithFellerBuncherAndGrappleSwingYarder.AsSpan());
            Span<float> batchRegenChainsawCmhWithFellerBuncherAndGrappleSwingYarder = MemoryMarshal.Cast<byte, float>(this.regenChainsawCmhWithFellerBuncherAndGrappleSwingYarder.AsSpan());
            Span<float> batchRegenChainsawPMhWithFellerBuncherAndGrappleSwingYarder = MemoryMarshal.Cast<byte, float>(this.regenChainsawPMhWithFellerBuncherAndGrappleSwingYarder.AsSpan());
            Span<ChainsawCrewType> batchRegenChainsawCrewWithFellerBuncherAndGrappleYoader = MemoryMarshal.Cast<byte, ChainsawCrewType>(this.regenChainsawCrewWithFellerBuncherAndGrappleYoader.AsSpan());
            Span<float> batchRegenChainsawUtilizationWithFellerBuncherAndGrappleYoader = MemoryMarshal.Cast<byte, float>(this.regenChainsawUtilizationWithFellerBuncherAndGrappleYoader.AsSpan());
            Span<float> batchRegenChainsawCmhWithFellerBuncherAndGrappleYoader = MemoryMarshal.Cast<byte, float>(this.regenChainsawCmhWithFellerBuncherAndGrappleYoader.AsSpan());
            Span<float> batchRegenChainsawPMhWithFellerBuncherAndGrappleYoader = MemoryMarshal.Cast<byte, float>(this.regenChainsawPMhWithFellerBuncherAndGrappleYoader.AsSpan());
            Span<ChainsawCrewType> batchRegenChainsawCrewWithTrackedHarvester = MemoryMarshal.Cast<byte, ChainsawCrewType>(this.regenChainsawCrewWithTrackedHarvester.AsSpan());
            Span<float> batchRegenChainsawUtilizationWithTrackedHarvester = MemoryMarshal.Cast<byte, float>(this.regenChainsawUtilizationWithTrackedHarvester.AsSpan());
            Span<float> batchRegenChainsawCmhWithTrackedHarvester = MemoryMarshal.Cast<byte, float>(this.regenChainsawCmhWithTrackedHarvester.AsSpan());
            Span<float> batchRegenChainsawPMhWithTrackedHarvester = MemoryMarshal.Cast<byte, float>(this.regenChainsawPMhWithTrackedHarvester.AsSpan());
            Span<ChainsawCrewType> batchRegenChainsawCrewWithWheeledHarvester = MemoryMarshal.Cast<byte, ChainsawCrewType>(this.regenChainsawCrewWithWheeledHarvester.AsSpan());
            Span<float> batchRegenChainsawUtilizationWithWheeledHarvester = MemoryMarshal.Cast<byte, float>(this.regenChainsawUtilizationWithWheeledHarvester.AsSpan());
            Span<float> batchRegenChainsawCmhWithWheeledHarvester = MemoryMarshal.Cast<byte, float>(this.regenChainsawCmhWithWheeledHarvester.AsSpan());
            Span<float> batchRegenChainsawPMhWithWheeledHarvester = MemoryMarshal.Cast<byte, float>(this.regenChainsawPMhWithWheeledHarvester.AsSpan());
            Span<float> batchRegenGrappleSwingYarderPMhPerHectare = MemoryMarshal.Cast<byte, float>(this.regenGrappleSwingYarderPMhPerHectare.AsSpan());
            Span<float> batchRegenGrappleSwingYarderProductivity = MemoryMarshal.Cast<byte, float>(this.regenGrappleSwingYarderProductivity.AsSpan());
            Span<float> batchRegenGrappleSwingYarderOverweightFirstLogsPerHectare = MemoryMarshal.Cast<byte, float>(this.regenGrappleSwingYarderOverweightFirstLogsPerHectare.AsSpan());
            Span<float> batchRegenGrappleYoaderPMhPerHectare = MemoryMarshal.Cast<byte, float>(this.regenGrappleYoaderPMhPerHectare.AsSpan());
            Span<float> batchRegenGrappleYoaderProductivity = MemoryMarshal.Cast<byte, float>(this.regenGrappleYoaderProductivity.AsSpan());
            Span<float> batchRegenGrappleYoaderOverweightFirstLogsPerHectare = MemoryMarshal.Cast<byte, float>(this.regenGrappleYoaderOverweightFirstLogsPerHectare.AsSpan());
            Span<float> batchRegenProcessorPMhWithGrappleSwingYarder = MemoryMarshal.Cast<byte, float>(this.regenProcessorPMhWithGrappleSwingYarder.AsSpan());
            Span<float> batchRegenProcessorProductivityWithGrappleSwingYarder = MemoryMarshal.Cast<byte, float>(this.regenProcessorProductivityWithGrappleSwingYarder.AsSpan());
            Span<float> batchRegenProcessorPMhWithGrappleYoader = MemoryMarshal.Cast<byte, float>(this.regenProcessorPMhWithGrappleYoader.AsSpan());
            Span<float> batchRegenProcessorProductivityWithGrappleYoader = MemoryMarshal.Cast<byte, float>(this.regenProcessorProductivityWithGrappleYoader.AsSpan());
            Span<float> batchRegenLoadedWeight = MemoryMarshal.Cast<byte, float>(this.regenLoadedWeight.AsSpan());

...
namespace Mars.Seem.Output
{
    public class StandTrajectoryArrowMemory : ArrowMemory
    {
        ...
        public int UncompressedBytesPerRow { get; private init; }

        public StandTrajectoryArrowMemory(int capacityInRecords)
            : base(capacityInRecords, 4 * 1000 * 1000) // 531 bytes / record * 400k records = 1.98 GB, https://github.com/apache/arrow/issues/37069
        {
            // create schema
            ...
            this.UncompressedBytesPerRow = ArrowMemory.GetUncompressedBytesPerRow(this.schema);

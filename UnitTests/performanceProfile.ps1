...
Set-Location -Path ([System.IO.Path]::Combine($env:USERPROFILE, "PhD\\Seem\\UnitTests\\bin\\x64"))
...
# CPU
$nelder1 = Get-StandsFromPermanentPlots -Plots 1 -Age 20 -Area 20 -ExpansionFactor 1.327 -PlantingDensity 1035 -File ([System.IO.Path]::Combine($env:USERPROFILE, "OSU\\Organon\\Malcolm Knapp Nelder 1.xlsx")) -TreesSheet "1";
$hero = Optimize-Hero -MaxIterations 2 -Threads 1 -Stand $nelder1 -Verbose

# .NET object allocation -> memory
#$plot14y16 = Get-StandsFromPermanentPlots -Plots (14, 16) -Age 30 -Area 20 -ExpansionFactor 2.127 -PlantingDensity 990 -SiteIndexInM 39.6 -File ([System.IO.Path]::Combine($env:USERPROFILE, "OSU\\Organon\\Malcolm Knapp plots 14-18+34 Ministry.xlsx")) -TreesSheet "0.2 ha";
...
#$plot14y16 = Get-StandsFromPermanentPlots -Plots (14, 16) -Age 30 -Area 20 -ExpansionFactorPerHa 2.132 -PlantingDensityPerHa 990 -SiteIndexInM 39.6 -File ([System.IO.Path]::Combine($env:USERPROFILE, "OSU\\Organon\\Malcolm Knapp plots 14-18+34 Ministry.xlsx")) -TreesSheet "0.2 ha"
#$harvestCosts10k = Get-FinancialScenarios -File ([System.IO.Path]::Combine($env:USERPROFILE, "cost variations 10000.xlsx"))
...
#$tsheCosts31500 = Get-FinancialScenarios -File ([System.IO.Path]::Combine($env:USERPROFILE, "OSU\\PhD\\papers\\harvest cost\\tshe harvest cost Sobol first order N = 500 31500.xlsx"))
#$plot21 = Get-StandsFromPermanentPlots -Plots 21 -Age 30 -Area 20 -ExpansionFactorPerHa 2.272 -ForwardingTethered 190 -PlantingDensityPerHa 1113 -HemlockSiteIndexInM 29.1 -SiteIndexInM 39.6 -SlopeInPercent 65 -File ([System.IO.Path]::Combine($env:USERPROFILE, "OSU\\Organon\\Malcolm Knapp plot 21 Ministry height imputed.xlsx")) -TreesSheet "Sheet1"

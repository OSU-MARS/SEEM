...
namespace Osu.Cof.Ferm.Heuristics
{
    public class RandomNumberConsumer
    {
        ...
        static RandomNumberConsumer()
        {
            RandomNumberConsumer.CryptographicRandom = RandomNumberGenerator.Create();
        }
        ...
        protected RandomNumberConsumer()
        {
            ...
            lock (RandomNumberConsumer.CryptographicRandom)
            {
                RandomNumberConsumer.CryptographicRandom.GetBytes(seed);
            }
        ...
        protected void ShuffleRandom(int[] array)
        {
